...
python main.py -m RLHFTraining --config_path config/training/ppo-main.json --epochs 1 --data_file data/ppo/sr/ml-100k-v2.jsonl --model_path ckpts/xxxx/epoch-0
# 2.2 Dataset: beauty
...
python main.py -m RLHFTraining --config_path config/training/ppo-main.json --epochs 1 --data_file data/ppo/sr/Beauty-v2.jsonl --model_path ckpts/xxxx/epoch-0